...
import {getTodaysDate} from "@/global";

const menuState = ref(false);

const navigation = [
  {title: "Home", path: `/namaz/${getTodaysDate()}`},
      ...
      <div class="flex-1 flex items-center justify-between">
        <div
          ...
          <ul class="mt-12 space-y-5 lg:flex lg:space-x-6 lg:space-y-0 lg:mt-0">
            <li v-for="link in navigation" :key="link.path" class="text-gray-600 hover:text-indigo-600">
